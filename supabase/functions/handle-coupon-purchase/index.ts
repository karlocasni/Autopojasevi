...
serve(async (req) => {
    ...
    try {
        ...
        if (type === "INSERT") {
            ...
            // Idempotency check? Assuming we trust the webhook for now or check a flag.
            // But let's just proceed.

            console.log(`New coupon purchased: ${record.id}. Sending emails...`);

            // 1. Email to Admin (Receipt Info)
            await fetch("https://api.resend.com/emails", {
                ...
                body: JSON.stringify({
                    ...
                    subject: "NOVI POKLON BON - PODACI ZA RAČUN",
                    html: `
                        <h2>Novi Poklon Bon Prodan!</h2>
                        <p>Molimo kreirajte i pošaljite račun kupcu.</p>
                        <div style="background: #f4f4f4; padding: 15px; border-radius: 5px;">
                            <h3>Podaci za Račun:</h3>
                            <p><strong>ID Narudžbe:</strong> ${record.id}</p>
                            <p><strong>Datum:</strong> ${new Date().toLocaleString()}</p>
                            <p><strong>Stavka:</strong> Poklon Bon (${record.amount} EUR)</p>
                            <p><strong>Cijena:</strong> ${record.amount} €</p>
                            <p><strong>Količina:</strong> 1</p>
                        </div>
                        <br>
                        <div style="background: #f4f4f4; padding: 15px; border-radius: 5px;">
                            <h3>Kupac (Platitelj):</h3>
                            <p><strong>Ime i prezime:</strong> ${record.purchaser_name}</p>
                            <p><strong>Email:</strong> ${record.purchaser_email}</p>
                            <p><strong>Telefon:</strong> ${record.purchaser_phone}</p>
                        </div>
                        <br>
                        <div style="background: #f4f4f4; padding: 15px; border-radius: 5px;">
                            <h3>Primatelj Bona:</h3>
                            <p><strong>Ime:</strong> ${record.recipient_name}</p>
                            <p><strong>Email:</strong> ${record.recipient_email}</p>
                            <p><strong>Poruka:</strong> ${record.recipient_message || '-'}</p>
                        </div>
                    `,
                }),
            });

            // 2. Email to Purchaser (Receipt/Confirmation)
            await fetch("https://api.resend.com/emails", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                ...
                body: JSON.stringify({
                    ...
                    to: [record.purchaser_email],
                    subject: "Potvrda kupnje poklon bona",
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-header-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#FFFFFF;width:600px">
             <tr>
              <td align="left" bgcolor="#cc0000" style="padding:10px;Margin:0;background-color:#cc0000">
                 ...
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0"><h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:28px;font-style:normal;font-weight:normal;line-height:33.6px;color:#333333"><strong>Hvala na interesu!</strong></h3></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Vaš poklon bon od <strong>${record.amount} EUR</strong> je uspješno kreiran.</p></td>
                     </tr>
                   </table></td>
                 </tr>
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Poslali smo ga na email adresu primatelja: <strong>${record.recipient_email}</strong>.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Uskoro ćemo Vam poslati račun na Vašu email adresu te će, nakon plaćanja, bon postati valjan.</p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
         ...
         <tr>
          <td align="center" style="padding:0;Margin:0">
           <table cellspacing="0" cellpadding="0" bgcolor="#ffffff" align="center" class="es-footer-body" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;background-color:#FFFFFF;width:600px">
               ...
               <table cellspacing="0" align="right" cellpadding="0" class="es-right" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;float:right">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><strong>Vaš Autopojasevi.hr tim</strong></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
             ...
             <tr>
              <td align="left" bgcolor="#333333" style="padding:20px;Margin:0;background-color:#333333">
               <table cellspacing="0" align="left" cellpadding="0" class="es-left" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px;float:left">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
            ...
            // 3. Email to Recipient (The Coupon)
            await fetch("https://api.resend.com/emails", {
                method: "POST",
                headers: {
                    "Content-Type": "application/json",
                ...
                body: JSON.stringify({
                    ...
                    subject: `Dobili ste POKLON BON od ${record.purchaser_name}!`,
                    html: `<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
<html dir="ltr" xmlns="http://www.w3.org/1999/xhtml" xmlns:o="urn:schemas-microsoft-com:office:office" lang="HR">
 <head>
  <meta charset="UTF-8">
               ...
               <table cellspacing="0" width="100%" cellpadding="0" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="center" class="es-m-txt-c" style="padding:0;Margin:0"><h3 style="Margin:0;font-family:arial, 'helvetica neue', helvetica, sans-serif;mso-line-height-rule:exactly;letter-spacing:0;font-size:28px;font-style:normal;font-weight:normal;line-height:33.6px;color:#333333"><strong>POKLON BON</strong></h3></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
               ...
               <table cellpadding="0" cellspacing="0" width="100%" role="none" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Dobili ste poklon bon od <strong>${record.amount} EUR </strong>od korisnika: <strong> ${record.purchaser_name} </strong>.</p></td>
                     </tr>
                   </table></td>
                 </tr>
                 <tr>
                  <td align="left" style="padding:0;Margin:0;width:560px">
                   <table role="presentation" width="100%" cellpadding="0" cellspacing="0" style="mso-table-lspace:0pt;mso-table-rspace:0pt;border-spacing:0px">
                     <tr>
                      <td align="left" style="padding:0;Margin:0;padding-top:10px"><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Ovaj bon možete iskoristiti za bilo koju uslugu u <strong>Autopojasevi.hr</strong>.</p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px"><br></p><p style="Margin:0;mso-line-height-rule:exactly;font-family:arial, 'helvetica neue', helvetica, sans-serif;line-height:21px;letter-spacing:0;color:#333333;font-size:14px">Kod bona: <strong>${record.id.toUpperCase().slice(0, 8)}</strong></p></td>
                     </tr>
                   </table></td>
                 </tr>
               </table></td>
